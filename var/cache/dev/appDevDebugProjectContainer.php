...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['app.form.registration'] = new \UserBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ce1Ol5-ilY', 0, (__DIR__.'/pools'));
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vUnrQER-bC', 0, 'oXhnMb+u0FMdXgG4rJUa6Q', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
=======
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PrsPvxw2qW', 0, 'JL40hcMv0xHVO1npfTG10-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
>>>>>>> 03ceab7eff324941ee7bd6e1662f40d597a34948
    }
...
>>>>>>> 03ceab7eff324941ee7bd6e1662f40d597a34948
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'questionthon', 'user' => 'root', 'password' => 'azerty', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/QuizzBundle/Entity'), 1 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'QuizzBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('QuizzBundle' => 'QuizzBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e37e9f82db4fd9df8ebf340e151f396a43168e8c1c7c79cdf7105abf6da10ada');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('UserBundle\\Entity\\Player');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('julienmartin.opto@gmail.com' => 'juienmartin.opto@gmail.com'), 'resetting' => array('julienmartin.opto@gmail.com' => 'juienmartin.opto@gmail.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('UserBundle\\Entity\\Player');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('UserBundle\\Entity\\Player');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('UserBundle\\Entity\\Player');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'UserBundle\\Entity\\Player');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('UserBundle\\Entity\\Player' => array('algorithm' => 'sha512', 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'encode_as_base64' => true, 'iterations' => 5000, 'cost' => 13)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/select');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/play$');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/result');
        ...
        $s = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $r, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($r, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
...
>>>>>>> 03ceab7eff324941ee7bd6e1662f40d597a34948
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/QuizzBundle/Resources/views'), 'Quizz');
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aqIx30OwY2', 0, 'oXhnMb+u0FMdXgG4rJUa6Q', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
=======
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xm9PxQUP0S', 0, 'JL40hcMv0xHVO1npfTG10-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
>>>>>>> 03ceab7eff324941ee7bd6e1662f40d597a34948
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'QuizzBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/QuizzBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'QuizzBundle' => 'QuizzBundle\\QuizzBundle',
            ...
            'fos_user.model.user.class' => 'UserBundle\\Entity\\Player',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'julienmartin.opto@gmail.com' => 'juienmartin.opto@gmail.com',
            ),
